       ...
       <div class="flex flex-wrap -mx-4 lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
             <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="block mb-4 text-white font-semibold text-primary">
                Contact Us
                </span>
                <h2
                   class="text-white dark:text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                   >
                   GET IN TOUCH WITH US
                </h2>
                <p
                   class="text-base leading-relaxed text-white dark:text-white-6 mb-9"
                   >
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                   ...
                   <div class="w-full">
                      ...
                      <p class="text-base text-white dark:text-white-6">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
             <div
                class="relative p-8 bg-neutral-900 rounded-lg shadow-lg  sm:p-12"
                >
...
<div className="mb-6">
 ...
 <input
   ...
   className="border-stroke dark:border-dark-3 dark:text-white-6 dark:bg-dark text-black  focus:border-primary w-full rounded border bordere py-3 px-4 text-base outline-none"
   required
 />
</div>
<div className="mb-6">
 ...
 <input
   ...
   className="border-stroke dark:border-dark-3 dark:text-white-6 dark:bg-dark text-black focus:border-primary w-full rounded border py-3 px-4 text-base outline-none"
   required
 />
</div>
<div className="mb-6">
 ...
 <textarea
   ...
   rows="6"
   className="border-stroke dark:border-dark-3 dark:text-white-6 dark:bg-dark text-black focus:border-primary w-full resize-none rounded border py-3 px-4 text-base outline-none"
   required
 ></textarea>
</div>
<div>
