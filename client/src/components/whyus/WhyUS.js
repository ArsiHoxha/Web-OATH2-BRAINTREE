...
const WhyUs = () => {
  ...
  return (
    <div className="bg-gray-900" id='WhyUS'>
      <section id="features" className="relative block px-6 py-10 md:py-20 md:px-10">
        <div className="relative mx-auto max-w-5xl text-center">
          <span className="font-extrabold text-white my-3 flex items-center justify-center  uppercase tracking-wider">
            Why choose us
          </span>
          <h2 className="block w-full bg-gradient-to-b font-extrabold text-white bg-clip-text  text-transparent text-3xl sm:text-4xl">
        ...
        <motion.div
          ...
          animate={controls}
        >
          <motion.div className="rounded-md border  bg-neutral-900/50 p-8 text-center shadow" variants={cardVariants}>
            <div
            ...
            <h3 className="mt-6 text-white font-bold">Customizable</h3>
          ...
          <motion.div className="rounded-md border  bg-neutral-900/50 p-8 text-center shadow" variants={cardVariants}>
            ...
            <h3 className="mt-6 text-white font-bold">Fast Performance</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-white">
          ...
          <motion.div className="rounded-md border  bg-neutral-900/50 p-8 text-center shadow" variants={cardVariants}>
            ...
            <h3 className="mt-6 text-white font-bold">Fully Featured</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-white">
